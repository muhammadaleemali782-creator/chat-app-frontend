...
const S = {
  ...
  liveClock: { color: "#64748B", fontSize: 11.5, marginTop: 1 },
  liveTime: { color: "#4F46E5", fontWeight: 700 },
  newBtn: {
    background: "#4F46E5",
    color: "#fff",
    border: "none",
  ...
  statNum: { fontWeight: 800, fontSize: 13, color: "#0F172A" },
  ...
  dayBarLabel: { fontWeight: 700, fontSize: 13, color: "#0F172A" },
  dayBarCount: { fontSize: 11.5, color: "#64748B" },
  timeline: {
    flex: 1,
    overflowY: "auto",
    overflowX: "hidden",
  ...
  meetTitle: { fontSize: 13.5, fontWeight: 700, color: "#0F172A", lineHeight: 1.3 },
  meetMeta: {
    fontSize: 11.5,
    color: "#64748B",
    marginTop: 2,
  ...
  declinedTag: { fontSize: 10.5, color: "#EF4444", marginTop: 2 },
  joinBtn: {
    background: "#4F46E5",
    color: "#fff",
    border: "none",
